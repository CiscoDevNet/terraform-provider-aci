		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_relation_from_l3out_consumer_label_to_route_control_profile.allow_test", "target_dn", "uni/tn-test_tenant/prof-rt_ctrl_profile"),
					resource.TestCheckResourceAttr("aci_relation_from_l3out_consumer_label_to_route_control_profile.allow_test_2", "target_dn", "uni/tn-test_tenant/prof-rt_ctrl_profile"),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				...
				ExpectNonEmptyPlan: false,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_relation_from_l3out_consumer_label_to_route_control_profile.test", "target_dn", "uni/tn-test_tenant/prof-rt_ctrl_profile"),
