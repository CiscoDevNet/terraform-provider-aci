		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_ip_sla_track_member.allow_test", "destination_ip_address", "2.2.2.2"),
					resource.TestCheckResourceAttr("aci_ip_sla_track_member.allow_test_2", "destination_ip_address", "2.2.2.2"),
		...
		Steps: []resource.TestStep{
			...
			// Update with all config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_ip_sla_track_member.test", "destination_ip_address", "destination_ip_address_1"),
...
resource "aci_ip_sla_track_member" "test" {
  ...
  destination_ip_address = "destination_ip_address_1"
