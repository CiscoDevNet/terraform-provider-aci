...
var _ datasource.DataSource = &L3extProvLblDataSource{}

func NewL3extProvLblDataSource() datasource.DataSource {
	return &L3extProvLblDataSource{}
}
...
func (d *L3extProvLblDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	tflog.Debug(ctx, "Start metadata of datasource: aci_l3out_provider_label")
	resp.TypeName = req.ProviderTypeName + "_l3out_provider_label"
	tflog.Debug(ctx, "End metadata of datasource: aci_l3out_provider_label")
}

func (d *L3extProvLblDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	tflog.Debug(ctx, "Start schema of datasource: aci_l3out_provider_label")
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "The l3out_provider_label datasource for the 'l3extProvLbl' class",
	...
	tflog.Debug(ctx, "End schema of datasource: aci_l3out_provider_label")
}
...
func (d *L3extProvLblDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	tflog.Debug(ctx, "Start configure of datasource: aci_l3out_provider_label")
	...
	d.client = client
	tflog.Debug(ctx, "End configure of datasource: aci_l3out_provider_label")
}

func (d *L3extProvLblDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	tflog.Debug(ctx, "Start read of datasource: aci_l3out_provider_label")
	...
	tflog.Debug(ctx, fmt.Sprintf("Read of datasource aci_l3out_provider_label with id '%s'", data.Id.ValueString()))

	getAndSetL3extProvLblAttributes(ctx, &resp.Diagnostics, d.client, data)

	if data.Id.IsNull() {
		resp.Diagnostics.AddError(
			"Failed to read aci_l3out_provider_label data source",
			fmt.Sprintf("The aci_l3out_provider_label data source with id '%s' has not been found", cachedId),
		)
		return
	}
	...
	tflog.Debug(ctx, fmt.Sprintf("End read of datasource aci_l3out_provider_label with id '%s'", data.Id.ValueString()))
}
