...
resource "aci_mld_snooping_policy" "test" {
  ...
  version = provider::aci::compare_versions(data.aci_system.version.version,"inside","5.1(1h)-") ? "unspecified" : null
}
`
...
resource "aci_mld_snooping_policy" "test" {
  ...
  version = provider::aci::compare_versions(data.aci_system.version.version,"inside","5.1(1h)-") ? "v2" : null
}
`
