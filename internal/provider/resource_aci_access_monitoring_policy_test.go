...
func TestAccResourceMonInfraPol(t *testing.T) {
		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.allow_test", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.allow_test_2", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.allow_test", "description", ""),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.allow_test_2", "description", ""),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.allow_test", "name_alias", ""),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.allow_test_2", "name_alias", ""),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.allow_test", "owner_key", ""),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.allow_test_2", "owner_key", ""),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.allow_test", "owner_tag", ""),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.allow_test_2", "owner_tag", ""),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			// Update with all config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.test", "description", "description_1"),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.test", "name_alias", "name_alias_1"),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.test", "owner_key", "owner_key_1"),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.test", "owner_tag", "owner_tag_1"),
				),
			},
			...
			// Import testing
			{
				ResourceName:      "aci_access_monitoring_policy.test",
				ImportState:       true,
			...
			// Update with all children removed
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.test", "owner_key", ""),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.test", "owner_tag", ""),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.test", "annotations.#", "0"),
					resource.TestCheckResourceAttr("aci_access_monitoring_policy.test", "tags.#", "0"),
				),
			},
		},
...
const testConfigMonInfraPolMinAllowExisting = `
resource "aci_access_monitoring_policy" "allow_test" {
  name = "test_name"
}
resource "aci_access_monitoring_policy" "allow_test_2" {
  name = "test_name"
  depends_on = [aci_access_monitoring_policy.allow_test]
}
`

const testConfigMonInfraPolMin = `
resource "aci_access_monitoring_policy" "test" {
  name = "test_name"
}
`

const testConfigMonInfraPolAll = `
resource "aci_access_monitoring_policy" "test" {
  name = "test_name"
...
const testConfigMonInfraPolReset = `
resource "aci_access_monitoring_policy" "test" {
  name = "test_name"
...
`
const testConfigMonInfraPolChildren = `
resource "aci_access_monitoring_policy" "test" {
  name = "test_name"
  annotations = [
	{
...
const testConfigMonInfraPolChildrenRemoveFromConfig = `
resource "aci_access_monitoring_policy" "test" {
  name = "test_name"
}
`

const testConfigMonInfraPolChildrenRemoveOne = `
resource "aci_access_monitoring_policy" "test" {
  name = "test_name"
  annotations = [ 
	{
...
const testConfigMonInfraPolChildrenRemoveAll = `
resource "aci_access_monitoring_policy" "test" {
  name = "test_name"
  annotations = []
  tags = []
