...
var _ datasource.DataSource = &FvEpMacTagDataSource{}
...
func (d *FvEpMacTagDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	tflog.Debug(ctx, "Start metadata of datasource: aci_endpoint_tag_mac")
	resp.TypeName = req.ProviderTypeName + "_endpoint_tag_mac"
	tflog.Debug(ctx, "End metadata of datasource: aci_endpoint_tag_mac")
}

func (d *FvEpMacTagDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	tflog.Debug(ctx, "Start schema of datasource: aci_endpoint_tag_mac")
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "The endpoint_tag_mac datasource for the 'fvEpMacTag' class",
	...
	tflog.Debug(ctx, "End schema of datasource: aci_endpoint_tag_mac")
}
...
func (d *FvEpMacTagDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	tflog.Debug(ctx, "Start configure of datasource: aci_endpoint_tag_mac")
	...
	d.client = client
	tflog.Debug(ctx, "End configure of datasource: aci_endpoint_tag_mac")
}

func (d *FvEpMacTagDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	tflog.Debug(ctx, "Start read of datasource: aci_endpoint_tag_mac")
	...
	tflog.Debug(ctx, fmt.Sprintf("Read of datasource aci_endpoint_tag_mac with id '%s'", data.Id.ValueString()))

	getAndSetFvEpMacTagAttributes(ctx, &resp.Diagnostics, d.client, data)

	if data.Id.IsNull() {
		resp.Diagnostics.AddError(
			"Failed to read aci_endpoint_tag_mac data source",
			fmt.Sprintf("The aci_endpoint_tag_mac data source with id '%s' has not been found", cachedId),
		)
		return
	}
	...
	tflog.Debug(ctx, fmt.Sprintf("End read of datasource aci_endpoint_tag_mac with id '%s'", data.Id.ValueString()))
}
