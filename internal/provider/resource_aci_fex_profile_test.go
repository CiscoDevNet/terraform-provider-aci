...
func TestAccResourceInfraFexP(t *testing.T) {
		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_fex_profile.allow_test", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("aci_fex_profile.allow_test_2", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("aci_fex_profile.allow_test", "description", ""),
					resource.TestCheckResourceAttr("aci_fex_profile.allow_test_2", "description", ""),
					resource.TestCheckResourceAttr("aci_fex_profile.allow_test", "name_alias", ""),
					resource.TestCheckResourceAttr("aci_fex_profile.allow_test_2", "name_alias", ""),
					resource.TestCheckResourceAttr("aci_fex_profile.allow_test", "owner_key", ""),
					resource.TestCheckResourceAttr("aci_fex_profile.allow_test_2", "owner_key", ""),
					resource.TestCheckResourceAttr("aci_fex_profile.allow_test", "owner_tag", ""),
					resource.TestCheckResourceAttr("aci_fex_profile.allow_test_2", "owner_tag", ""),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			// Update with all config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_fex_profile.test", "description", "description_1"),
					resource.TestCheckResourceAttr("aci_fex_profile.test", "name_alias", "name_alias_1"),
					resource.TestCheckResourceAttr("aci_fex_profile.test", "owner_key", "owner_key_1"),
					resource.TestCheckResourceAttr("aci_fex_profile.test", "owner_tag", "owner_tag_1"),
				),
			},
			...
			// Update with children
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					composeAggregateTestCheckFuncWithVersion(t, "3.2(1l)-", "inside",
						...
						resource.TestCheckResourceAttr("aci_fex_profile.test", "annotations.1.key", "key_1"),
					...
					composeAggregateTestCheckFuncWithVersion(t, "3.2(1l)-", "inside",
						...
						resource.TestCheckResourceAttr("aci_fex_profile.test", "tags.1.key", "key_1"),
						resource.TestCheckResourceAttr("aci_fex_profile.test", "tags.1.value", "test_value"),
						resource.TestCheckResourceAttr("aci_fex_profile.test", "tags.#", "2"),
					),
				),
			},
			...
			// Update with children first child removed
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					composeAggregateTestCheckFuncWithVersion(t, "3.2(1l)-", "inside",
						...
						resource.TestCheckResourceAttr("aci_fex_profile.test", "tags.#", "1"),
					),
				),
			},
			// Update with all children removed
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_fex_profile.test", "owner_key", ""),
					resource.TestCheckResourceAttr("aci_fex_profile.test", "owner_tag", ""),
					resource.TestCheckResourceAttr("aci_fex_profile.test", "annotations.#", "0"),
					resource.TestCheckResourceAttr("aci_fex_profile.test", "tags.#", "0"),
				),
			},
		},
...
resource "aci_fex_profile" "allow_test" {
  name = "test_name"
}
resource "aci_fex_profile" "allow_test_2" {
  name = "test_name"
  depends_on = [aci_fex_profile.allow_test]
}
`

const testConfigInfraFexPMin = `
resource "aci_fex_profile" "test" {
  name = "test_name"
}
`

const testConfigInfraFexPAll = `
resource "aci_fex_profile" "test" {
  name = "test_name"
...
const testConfigInfraFexPReset = `
resource "aci_fex_profile" "test" {
  name = "test_name"
...
`
const testConfigInfraFexPChildren = `
resource "aci_fex_profile" "test" {
  name = "test_name"
  annotations = [
	{
...
const testConfigInfraFexPChildrenRemoveOne = `
resource "aci_fex_profile" "test" {
  name = "test_name"
  annotations = [ 
	{
...
const testConfigInfraFexPChildrenRemoveAll = `
resource "aci_fex_profile" "test" {
  name = "test_name"
  annotations = []
  tags = []
