		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.aci_key_ring.test", "cert", ""),
					resource.TestCheckResourceAttr("data.aci_key_ring.test", "description", ""),
					resource.TestCheckResourceAttr("data.aci_key_ring.test", "ecc_curve", "none"),
					...
					resource.TestCheckResourceAttr("data.aci_key_ring.test", "regen", "no"),
					resource.TestCheckResourceAttr("data.aci_key_ring.test", "tp", ""),
				),
			},
			{
