		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_l3out_management_network_oob_contract.test", "contract_name", "test_l3out_management_network_contract"),
			...
			// Update with all config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_l3out_management_network_oob_contract.test", "contract_name", "test_l3out_management_network_contract"),
					resource.TestCheckResourceAttr("aci_l3out_management_network_oob_contract.test", "annotation", "test_annotation"),
