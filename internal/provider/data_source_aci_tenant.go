	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"relation_fv_rs_tenant_mon_pol": schema.StringAttribute{
				Computed:           true,
				DeprecationMessage: "Attribute 'relation_fv_rs_tenant_mon_pol' is deprecated, please refer to 'relation_to_tenant_monitoring_policy.monitoring_policy_name' instead. The attribute will be removed in the next major version of the provider.",
			},
			...
			"relation_to_tenant_monitoring_policy": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"monitoring_policy_name": schema.StringAttribute{
						Computed:            true,
						MarkdownDescription: `The monitoring policy name for the EPG semantic scope.`,
					},
