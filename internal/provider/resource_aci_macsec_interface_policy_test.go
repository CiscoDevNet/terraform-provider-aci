...
func TestAccResourceMacsecIfPol(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testConfigMacsecIfPolMinAllowExisting + testConfigDataSourceSystem,
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				Config: testConfigMacsecIfPolMin + testConfigDataSourceSystem,
				Check: resource.ComposeAggregateTestCheckFunc(
			...
			{
				Config: testConfigMacsecIfPolAll + testConfigDataSourceSystem,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "name", "test_name"),
			...
			{
				Config: testConfigMacsecIfPolReset + testConfigDataSourceSystem,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "name", "test_name"),
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "admin_state", "enabled"),
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "annotation", "orchestrator:terraform"),
			...
			{
				Config: testConfigMacsecIfPolChildren + testConfigDataSourceSystem,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "admin_state", "enabled"),
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "description", ""),
					...
					composeAggregateTestCheckFuncWithVersion(t, "3.1(1i)-", "inside",
			...
			{
				Config: testConfigMacsecIfPolChildrenRemoveFromConfig + testConfigDataSourceSystem,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "admin_state", "enabled"),
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "description", ""),
			...
			{
				Config: testConfigMacsecIfPolChildrenRemoveOne + testConfigDataSourceSystem,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "admin_state", "enabled"),
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "description", ""),
			...
			{
				Config: testConfigMacsecIfPolChildrenRemoveAll + testConfigDataSourceSystem,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "admin_state", "enabled"),
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("aci_macsec_interface_policy.test", "description", ""),
