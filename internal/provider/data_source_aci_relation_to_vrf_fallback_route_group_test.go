		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.aci_relation_to_vrf_fallback_route_group.test", "target_dn", "uni/tn-test_name/ctx-test_vrf/fbrg-vrf_fallback_route_group_0"),
			...
			},
			{
				...
				ExpectError: regexp.MustCompile("Failed to read aci_relation_to_vrf_fallback_route_group data source"),
			},
		},
	})
}
...
data "aci_relation_to_vrf_fallback_route_group" "test_non_existing" {
  parent_dn = aci_l3_outside.test.id
  target_dn = "uni/tn-test_name/ctx-test_vrf/fbrg-vrf_fallback_route_group_0_not_existing"
}
`
