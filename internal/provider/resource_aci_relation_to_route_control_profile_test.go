		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.allow_test", "target_dn", "uni/tn-test_tenant/prof-rt_ctrl_profile"),
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.allow_test_2", "target_dn", "uni/tn-test_tenant/prof-rt_ctrl_profile"),
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.allow_test", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.allow_test_2", "annotation", "orchestrator:terraform"),
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.allow_test", "direction", "import"),
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.allow_test_2", "direction", "import"),
				),
			},
		},
	})
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create with minimum config and verify default APIC values
			{
				...
				ExpectNonEmptyPlan: false,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.test", "target_dn", "uni/tn-test_tenant/prof-rt_ctrl_profile"),
			...
			// Update with children
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.test", "annotations.1.value", "test_value"),
					...
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.test", "tags.1.value", "test_value"),
				),
			},
			...
			// Update with children first child removed
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.test", "annotations.0.value", "test_value"),
					...
					resource.TestCheckResourceAttr("aci_relation_to_route_control_profile.test", "tags.0.value", "test_value"),
...
resource "aci_relation_to_route_control_profile" "allow_test" {
  parent_dn = aci_l3out_consumer_label.test.id
  direction = "import"
  target_dn = "uni/tn-test_tenant/prof-rt_ctrl_profile"
}
resource "aci_relation_to_route_control_profile" "allow_test_2" {
  parent_dn = aci_l3out_consumer_label.test.id
  direction = "import"
  target_dn = "uni/tn-test_tenant/prof-rt_ctrl_profile"
  depends_on = [aci_relation_to_route_control_profile.allow_test]
}
`
