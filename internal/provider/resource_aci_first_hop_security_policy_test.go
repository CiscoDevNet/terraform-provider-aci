		...
		Steps: []resource.TestStep{
			...
			// Update with children
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_first_hop_security_policy.test", "route_advertisement_guard_policy.max_router_pref", "disabled"),
					...
					statecheck.ExpectKnownValue("aci_first_hop_security_policy.test",
						...
						knownvalue.MapExact(
							map[string]knownvalue.Check{
								...
								"max_router_pref":      knownvalue.Null(),
