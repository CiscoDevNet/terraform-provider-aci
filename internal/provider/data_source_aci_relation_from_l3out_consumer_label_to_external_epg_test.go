		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.aci_relation_from_l3out_consumer_label_to_external_epg.test", "target_dn", "uni/tn-test_name/out-test_l3_outside/instP-inst_profile_1"),
...
data "aci_relation_from_l3out_consumer_label_to_external_epg" "test_non_existing" {
  parent_dn = aci_l3out_consumer_label.test.id
  target_dn = "uni/tn-test_name/out-test_l3_outside/instP-inst_profile_1_not_existing"
}
`
