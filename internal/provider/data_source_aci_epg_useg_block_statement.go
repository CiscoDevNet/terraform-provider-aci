...
func (d *FvCrtrnDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	tflog.Debug(ctx, "Start metadata of datasource: aci_epg_useg_block_statement")
	resp.TypeName = req.ProviderTypeName + "_epg_useg_block_statement"
	tflog.Debug(ctx, "End metadata of datasource: aci_epg_useg_block_statement")
}

func (d *FvCrtrnDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	tflog.Debug(ctx, "Start schema of datasource: aci_epg_useg_block_statement")
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "The epg_useg_block_statement datasource for the 'fvCrtrn' class",
	...
	tflog.Debug(ctx, "End schema of datasource: aci_epg_useg_block_statement")
}

func (d *FvCrtrnDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	tflog.Debug(ctx, "Start configure of datasource: aci_epg_useg_block_statement")
	...
	d.client = client
	tflog.Debug(ctx, "End configure of datasource: aci_epg_useg_block_statement")
}

func (d *FvCrtrnDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	tflog.Debug(ctx, "Start read of datasource: aci_epg_useg_block_statement")
	...
	tflog.Debug(ctx, fmt.Sprintf("Read of datasource aci_epg_useg_block_statement with id '%s'", data.Id.ValueString()))

	getAndSetFvCrtrnAttributes(ctx, &resp.Diagnostics, d.client, data)

	if data.Id.IsNull() {
		resp.Diagnostics.AddError(
			"Failed to read aci_epg_useg_block_statement data source",
			fmt.Sprintf("The aci_epg_useg_block_statement data source with id '%s' has not been found", cachedId),
		)
		return
	}
	...
	tflog.Debug(ctx, fmt.Sprintf("End read of datasource aci_epg_useg_block_statement with id '%s'", data.Id.ValueString()))
}
