		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.aci_relation_to_contract_master.test", "target_dn", "uni/tn-test_name/ap-test_name/epg-epg_0"),
		...
		Steps: []resource.TestStep{
			{
				...
				ExpectNonEmptyPlan: false,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.aci_relation_to_contract_master.test", "target_dn", "uni/tn-test_name/ap-test_name/esg-esg_0"),
					resource.TestCheckResourceAttr("data.aci_relation_to_contract_master.test", "annotation", "orchestrator:terraform"),
				),
			},
			{
...
data "aci_relation_to_contract_master" "test_non_existing" {
  parent_dn = aci_application_epg.test.id
  target_dn = "uni/tn-test_name/ap-test_name/epg-epg_0_not_existing"
}
`
...
data "aci_relation_to_contract_master" "test_non_existing" {
  parent_dn = aci_endpoint_security_group.test.id
  target_dn = "uni/tn-test_name/ap-test_name/esg-esg_0_not_existing"
}
`
