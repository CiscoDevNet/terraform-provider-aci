		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.aci_relation_to_fallback_route_group.test", "target_dn", "uni/tn-test_tenant/ctx-test_vrf/fbrg-fallback_route_group_0"),
					resource.TestCheckResourceAttr("data.aci_relation_to_fallback_route_group.test", "annotation", "orchestrator:terraform"),
				),
			},
			{
				Config:      testConfigL3extRsOutToFBRGroupNotExistingL3extOut,
				ExpectError: regexp.MustCompile("Failed to read aci_relation_to_fallback_route_group data source"),
			},
		},
	})
}
...
data "aci_relation_to_fallback_route_group" "test" {
...
data "aci_relation_to_fallback_route_group" "test_non_existing" {
  parent_dn = aci_l3_outside.test.id
