		...
		Steps: []resource.TestStep{
			...
			// Update with children
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_management_access_policy.test", "http_service.access_control_allow_credential", "disabled"),
					resource.TestCheckResourceAttr("aci_management_access_policy.test", "http_service.access_control_allow_origins", "access_control_allow_origins_1"),
					...
					resource.TestCheckResourceAttr("aci_management_access_policy.test", "http_service.throttle_rate", "2"),
					resource.TestCheckResourceAttr("aci_management_access_policy.test", "http_service.throttle_state", "disabled"),
					...
					resource.TestCheckResourceAttr("aci_management_access_policy.test", "http_ssl_configuration.access_control_allow_credential", "disabled"),
					resource.TestCheckResourceAttr("aci_management_access_policy.test", "http_ssl_configuration.access_control_allow_origins", "access_control_allow_origins_1"),
					...
					resource.TestCheckResourceAttr("aci_management_access_policy.test", "http_ssl_configuration.dh_param", "1024"),
					...
					resource.TestCheckResourceAttr("aci_management_access_policy.test", "http_ssl_configuration.throttle_rate", "2"),
					resource.TestCheckResourceAttr("aci_management_access_policy.test", "http_ssl_configuration.throttle_state", "disabled"),
					composeAggregateTestCheckFuncWithVersion(t, "4.0(1h)", ">=",
						resource.TestCheckResourceAttr("aci_management_access_policy.test", "http_ssl_configuration.client_cert_auth_state", "disabled")),
					composeAggregateTestCheckFuncWithVersion(t, "4.1(1i)", ">=",
					...
					composeAggregateTestCheckFuncWithVersion(t, "4.1(1i)", ">=",
						resource.TestCheckResourceAttr("aci_management_access_policy.test", "ssh_service.password_auth", "disabled")),
...
resource "aci_management_access_policy" "test" {
  ...
  ssh_service = {
    ...
    ssh_macs = ["hmac-sha1"]
  	password_auth = provider::aci::compare_versions(data.aci_system.version.version,">=","4.1(1i)") ? "disabled" : null
  }
  tags = [
	{
	  key = "key_0"
