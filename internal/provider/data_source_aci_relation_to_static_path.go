...
var _ datasource.DataSource = &FvRsPathAttDataSource{}
...
func (d *FvRsPathAttDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	tflog.Debug(ctx, "Start metadata of datasource: aci_relation_to_static_path")
	resp.TypeName = req.ProviderTypeName + "_relation_to_static_path"
	tflog.Debug(ctx, "End metadata of datasource: aci_relation_to_static_path")
}

func (d *FvRsPathAttDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	tflog.Debug(ctx, "Start schema of datasource: aci_relation_to_static_path")
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "The relation_to_static_path datasource for the 'fvRsPathAtt' class",
	...
	tflog.Debug(ctx, "End schema of datasource: aci_relation_to_static_path")
}
...
func (d *FvRsPathAttDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	tflog.Debug(ctx, "Start configure of datasource: aci_relation_to_static_path")
	...
	d.client = client
	tflog.Debug(ctx, "End configure of datasource: aci_relation_to_static_path")
}

func (d *FvRsPathAttDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	tflog.Debug(ctx, "Start read of datasource: aci_relation_to_static_path")
	...
	tflog.Debug(ctx, fmt.Sprintf("Read of datasource aci_relation_to_static_path with id '%s'", data.Id.ValueString()))

	getAndSetFvRsPathAttAttributes(ctx, &resp.Diagnostics, d.client, data)

	if data.Id.IsNull() {
		resp.Diagnostics.AddError(
			"Failed to read aci_relation_to_static_path data source",
			fmt.Sprintf("The aci_relation_to_static_path data source with id '%s' has not been found", cachedId),
		)
		return
	}
	...
	tflog.Debug(ctx, fmt.Sprintf("End read of datasource aci_relation_to_static_path with id '%s'", data.Id.ValueString()))
}
