...
func (d *L3extRsOutToFBRGroupDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	tflog.Debug(ctx, "Start metadata of datasource: aci_l3out_to_fallback_route_group")
	resp.TypeName = req.ProviderTypeName + "_l3out_to_fallback_route_group"
	tflog.Debug(ctx, "End metadata of datasource: aci_l3out_to_fallback_route_group")
}
...
func (d *L3extRsOutToFBRGroupDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	tflog.Debug(ctx, "Start schema of datasource: aci_l3out_to_fallback_route_group")
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "The l3out_to_fallback_route_group datasource for the 'l3extRsOutToFBRGroup' class",
	...
	tflog.Debug(ctx, "End schema of datasource: aci_l3out_to_fallback_route_group")
}
...
func (d *L3extRsOutToFBRGroupDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	tflog.Debug(ctx, "Start configure of datasource: aci_l3out_to_fallback_route_group")
	...
	d.client = client
	tflog.Debug(ctx, "End configure of datasource: aci_l3out_to_fallback_route_group")
}

func (d *L3extRsOutToFBRGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	tflog.Debug(ctx, "Start read of datasource: aci_l3out_to_fallback_route_group")
	...
	tflog.Debug(ctx, fmt.Sprintf("Read of datasource aci_l3out_to_fallback_route_group with id '%s'", data.Id.ValueString()))

	getAndSetL3extRsOutToFBRGroupAttributes(ctx, &resp.Diagnostics, d.client, data)

	if data.Id.IsNull() {
		resp.Diagnostics.AddError(
			"Failed to read aci_l3out_to_fallback_route_group data source",
			fmt.Sprintf("The aci_l3out_to_fallback_route_group data source with id '%s' has not been found", cachedId),
		)
		return
	}
	...
	tflog.Debug(ctx, fmt.Sprintf("End read of datasource aci_l3out_to_fallback_route_group with id '%s'", data.Id.ValueString()))
}
