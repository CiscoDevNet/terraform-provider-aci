...
var _ datasource.DataSource = &FvRsProvDataSource{}

func NewFvRsProvDataSource() datasource.DataSource {
	return &FvRsProvDataSource{}
}
...
func (d *FvRsProvDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	tflog.Debug(ctx, "Start metadata of datasource: aci_relation_to_provided_contract")
...
func (d *FvRsProvDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	tflog.Debug(ctx, "Start schema of datasource: aci_relation_to_provided_contract")
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "The relation_to_provided_contract datasource for the 'fvRsProv' class",
	...
	tflog.Debug(ctx, "End schema of datasource: aci_relation_to_provided_contract")
}
...
func (d *FvRsProvDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	tflog.Debug(ctx, "Start configure of datasource: aci_relation_to_provided_contract")
	...
	d.client = client
	tflog.Debug(ctx, "End configure of datasource: aci_relation_to_provided_contract")
}
...
func (d *FvRsProvDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	tflog.Debug(ctx, fmt.Sprintf("Read of datasource aci_relation_to_provided_contract with id '%s'", data.Id.ValueString()))

	getAndSetFvRsProvAttributes(ctx, &resp.Diagnostics, d.client, data)

	if data.Id.IsNull() {
		resp.Diagnostics.AddError(
			"Failed to read aci_relation_to_provided_contract data source",
			fmt.Sprintf("The aci_relation_to_provided_contract data source with id '%s' has not been found", cachedId),
		)
		return
	}
	...
	tflog.Debug(ctx, fmt.Sprintf("End read of datasource aci_relation_to_provided_contract with id '%s'", data.Id.ValueString()))
}
