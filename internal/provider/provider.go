...
func (p *AciProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewCdpIfPolResource,
		NewCommPolResource,
		NewCoppIfPolResource,
		NewCoppProtoClassPResource,
		NewDwdmIfPolResource,
		NewEigrpCtxAfPolResource,
		NewFabricHIfPolResource,
		...
		NewFvFabricExtConnPResource,
		NewFvIdGroupAttrResource,
		NewFvIpAttrResource,
		NewFvMacAttrResource,
		NewFvRemoteIdResource,
		NewFvRogueExceptionMacResource,
		NewFvRsAepAttResource,
		NewFvRsBDToNetflowMonitorPolResource,
		NewFvRsBDToOutResource,
		NewFvRsConsResource,
		NewFvRsConsIfResource,
		NewFvRsCtxToBgpCtxAfPolResource,
		NewFvRsCtxToEigrpCtxAfPolResource,
		NewFvRsCtxToOspfCtxPolResource,
		NewFvRsDomAttResource,
		NewFvRsFcPathAttResource,
		NewFvRsIntraEpgResource,
		NewFvRsNodeAttResource,
		NewFvRsOtmListMemberResource,
		NewFvRsPathAttResource,
		NewFvRsProtByResource,
		NewFvRsProvResource,
		NewFvRsSecInheritedResource,
		NewFvSCrtrnResource,
		NewFvSiteAssociatedResource,
		NewFvTenantResource,
		NewFvTrackListResource,
		NewFvTrackMemberResource,
		NewFvVipResource,
		NewFvVmAttrResource,
		NewFvnsAddrInstResource,
		NewFvnsUcastAddrBlkResource,
		NewIgmpSnoopPolResource,
		NewInfraAccPortPResource,
		NewInfraAttEntityPResource,
		NewInfraFexPResource,
		NewInfraHPathSResource,
		NewInfraHPortSResource,
		NewInfraPortBlkResource,
		NewInfraRsDomPResource,
		NewInfraSHPortSResource,
		NewInfraSpAccPortPResource,
		NewL2IfPolResource,
		NewL2InstPolResource,
		NewL2PortAuthPolResource,
		NewL2PortSecurityPolResource,
		NewL3extConsLblResource,
		NewL3extInstPResource,
		NewL3extProvLblResource,
		NewL3extRsInstPToProfileResource,
		...
		NewLacpEnhancedLagPolResource,
		NewLldpIfPolResource,
		NewMacsecIfPolResource,
		NewMacsecKeyChainPolResource,
		NewMacsecKeyPolResource,
		NewMacsecParamPolResource,
		NewMcpIfPolResource,
		NewMgmtInstPResource,
		NewMgmtRsOoBConsResource,
		NewMgmtSubnetResource,
		NewMldSnoopPolResource,
		NewMonInfraPolResource,
		NewMplsNodeSidPResource,
		NewNdIfPolResource,
		NewNetflowExporterPolResource,
		...
		NewQosDot1PClassResource,
		NewQosDppPolResource,
		NewQosDscpClassResource,
		NewQosLlfcIfPolResource,
		NewQosNodropDscpMatchIfPolResource,
		NewQosPfcIfPolResource,
		NewQosSdIfPolResource,
		...
		NewTagTagResource,
		NewVmmDomPResource,
		NewVmmUplinkPResource,
		NewVmmUplinkPContResource,
		NewVmmUsrAccPResource,
		NewVnsLDevIfResource,
		NewVzAnyResource,
		NewVzOOBBrCPResource,
		NewVzRsAnyToConsResource,
		NewVzRsAnyToConsIfResource,
		NewVzRsAnyToProvResource,
...
func (p *AciProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewCdpIfPolDataSource,
		NewCommPolDataSource,
		NewCoppIfPolDataSource,
		NewCoppProtoClassPDataSource,
		NewDwdmIfPolDataSource,
		NewEigrpCtxAfPolDataSource,
		NewFabricHIfPolDataSource,
		NewFabricLinkFlapPolDataSource,
		NewFcIfPolDataSource,
		...
		NewFvFabricExtConnPDataSource,
		NewFvIdGroupAttrDataSource,
		NewFvIpAttrDataSource,
		NewFvMacAttrDataSource,
		NewFvRemoteIdDataSource,
		NewFvRogueExceptionMacDataSource,
		NewFvRsAepAttDataSource,
		NewFvRsBDToNetflowMonitorPolDataSource,
		NewFvRsBDToOutDataSource,
		NewFvRsConsDataSource,
		NewFvRsConsIfDataSource,
		NewFvRsCtxToBgpCtxAfPolDataSource,
		NewFvRsCtxToEigrpCtxAfPolDataSource,
		NewFvRsCtxToOspfCtxPolDataSource,
		NewFvRsDomAttDataSource,
		NewFvRsFcPathAttDataSource,
		NewFvRsIntraEpgDataSource,
		NewFvRsNodeAttDataSource,
		NewFvRsOtmListMemberDataSource,
		NewFvRsPathAttDataSource,
		NewFvRsProtByDataSource,
		NewFvRsProvDataSource,
		NewFvRsSecInheritedDataSource,
		NewFvSCrtrnDataSource,
		NewFvSiteAssociatedDataSource,
		NewFvTenantDataSource,
		NewFvTrackListDataSource,
		NewFvTrackMemberDataSource,
		NewFvVipDataSource,
		NewFvVmAttrDataSource,
		NewFvnsAddrInstDataSource,
		NewFvnsUcastAddrBlkDataSource,
		NewIgmpSnoopPolDataSource,
		NewInfraAccPortPDataSource,
		NewInfraAttEntityPDataSource,
		NewInfraFexPDataSource,
		NewInfraHPathSDataSource,
		NewInfraHPortSDataSource,
		NewInfraPortBlkDataSource,
		NewInfraRsDomPDataSource,
		NewInfraSHPortSDataSource,
		NewInfraSpAccPortPDataSource,
		NewL2IfPolDataSource,
		NewL2InstPolDataSource,
		NewL2PortAuthPolDataSource,
		NewL2PortSecurityPolDataSource,
		NewL3extConsLblDataSource,
		NewL3extInstPDataSource,
		NewL3extProvLblDataSource,
		NewL3extRsInstPToProfileDataSource,
		...
		NewLacpEnhancedLagPolDataSource,
		NewLldpIfPolDataSource,
		NewMacsecIfPolDataSource,
		NewMacsecKeyChainPolDataSource,
		NewMacsecKeyPolDataSource,
		NewMacsecParamPolDataSource,
		NewMcpIfPolDataSource,
		NewMgmtInstPDataSource,
		NewMgmtRsOoBConsDataSource,
		NewMgmtSubnetDataSource,
		NewMldSnoopPolDataSource,
		NewMonInfraPolDataSource,
		NewMplsNodeSidPDataSource,
		NewNdIfPolDataSource,
		NewNetflowExporterPolDataSource,
		NewNetflowMonitorPolDataSource,
		NewNetflowRecordPolDataSource,
		NewNetflowRsMonitorToExporterDataSource,
		NewNwsFwPolDataSource,
		NewPimRouteMapEntryDataSource,
		NewPimRouteMapPolDataSource,
		NewPkiKeyRingDataSource,
		NewPkiTPDataSource,
		NewPoeIfPolDataSource,
		NewQosCustomPolDataSource,
		NewQosDot1PClassDataSource,
		NewQosDppPolDataSource,
		NewQosDscpClassDataSource,
		NewQosLlfcIfPolDataSource,
		NewQosNodropDscpMatchIfPolDataSource,
		NewQosPfcIfPolDataSource,
		NewQosSdIfPolDataSource,
		NewRtctrlProfileDataSource,
		NewStpIfPolDataSource,
		NewSynceEthIfPolDataSource,
		NewTagAnnotationDataSource,
		NewTagTagDataSource,
		NewVmmDomPDataSource,
		NewVmmUplinkPDataSource,
		NewVmmUplinkPContDataSource,
		NewVmmUsrAccPDataSource,
		NewVnsLDevIfDataSource,
		NewVzAnyDataSource,
		NewVzOOBBrCPDataSource,
		NewVzRsAnyToConsDataSource,
		NewVzRsAnyToConsIfDataSource,
		NewVzRsAnyToProvDataSource,
