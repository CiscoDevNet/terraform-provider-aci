		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.aci_netflow_exporter_policy.test", "dst_addr", "2.2.2.1"),
					resource.TestCheckResourceAttr("data.aci_netflow_exporter_policy.test", "dst_port", "https"),
					...
					resource.TestCheckResourceAttr("data.aci_netflow_exporter_policy.test", "src_addr", "1.1.1.1/10"),
					resource.TestCheckResourceAttr("data.aci_netflow_exporter_policy.test", "ver", "v9"),
				),
			},
			{
