		...
		Steps: []resource.TestStep{
			...
			// Update with children
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_contract_masters.0.target_dn", "uni/tn-test_tenant/ap-test_name/epg-epg_0"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_contract_masters.1.annotation", "annotation_2"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_contract_masters.1.target_dn", "uni/tn-test_tenant/ap-test_name/epg-epg_1"),
					...
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.annotation", "annotation_1"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.monitoring_policy_name", "monitoring_policy_name_1"),
			...
			// Update with children removed from config
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.annotation", "annotation_1"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.annotations.0.key", "key_0"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.annotations.0.value", "value_1"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.annotations.1.key", "key_1"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.annotations.1.value", "test_value"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "annotations.#", "2"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.tags.0.key", "key_0"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.tags.0.value", "value_1"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.tags.1.key", "key_1"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.tags.1.value", "test_value"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "tags.#", "2"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_monitor_policy.monitoring_policy_name", "monitoring_policy_name_1"),
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_provided_contracts.0.annotation", "annotation_1"),
			...
			// Update with children first child removed
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_application_epg.test", "relation_to_contract_masters.0.target_dn", "uni/tn-test_tenant/ap-test_name/epg-epg_1"),
