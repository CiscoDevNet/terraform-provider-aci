		...
		Steps: []resource.TestStep{
			...
			// Update with children
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.0.annotation", "annotation_1"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.0.tn_netflow_record_pol_name", "tn_netflow_record_pol_name_1"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.1.annotation", "annotation_2"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.1.tn_netflow_record_pol_name", "tn_netflow_record_pol_name_2"),
			...
			// Update with children removed from config
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.1.annotation", "annotation_2"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.1.tn_netflow_record_pol_name", "tn_netflow_record_pol_name_2"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.#", "2"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "tags.0.key", "key_0"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "tags.0.value", "value_1"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "tags.1.key", "key_1"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "tags.1.value", "value_2"),
			...
			// Update with children first child removed
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.0.annotation", "annotation_2"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.0.tn_netflow_record_pol_name", "tn_netflow_record_pol_name_2"),
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.#", "1"),
			...
			// Update with all children removed
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aci_netflow_monitor_policy.test", "record_policy_attachment.#", "0"),
...
resource "aci_netflow_monitor_policy" "test" {
  ...
  record_policy_attachment = [
	...
	},
	{
	  ...
	  tn_netflow_record_pol_name = "tn_netflow_record_pol_name_2"
	},
  ]
  tags = [
	{
