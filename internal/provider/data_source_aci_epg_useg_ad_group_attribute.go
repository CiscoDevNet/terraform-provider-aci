...
func (d *FvIdGroupAttrDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	tflog.Debug(ctx, "Start metadata of datasource: aci_epg_useg_ad_group_attribute")
	resp.TypeName = req.ProviderTypeName + "_epg_useg_ad_group_attribute"
	tflog.Debug(ctx, "End metadata of datasource: aci_epg_useg_ad_group_attribute")
}

func (d *FvIdGroupAttrDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	tflog.Debug(ctx, "Start schema of datasource: aci_epg_useg_ad_group_attribute")
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "The epg_useg_ad_group_attribute datasource for the 'fvIdGroupAttr' class",
	...
	tflog.Debug(ctx, "End schema of datasource: aci_epg_useg_ad_group_attribute")
}
...
func (d *FvIdGroupAttrDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	tflog.Debug(ctx, "Start configure of datasource: aci_epg_useg_ad_group_attribute")
	...
	d.client = client
	tflog.Debug(ctx, "End configure of datasource: aci_epg_useg_ad_group_attribute")
}

func (d *FvIdGroupAttrDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	tflog.Debug(ctx, "Start read of datasource: aci_epg_useg_ad_group_attribute")
	...
	tflog.Debug(ctx, fmt.Sprintf("Read of datasource aci_epg_useg_ad_group_attribute with id '%s'", data.Id.ValueString()))

	getAndSetFvIdGroupAttrAttributes(ctx, &resp.Diagnostics, d.client, data)

	if data.Id.IsNull() {
		resp.Diagnostics.AddError(
			"Failed to read aci_epg_useg_ad_group_attribute data source",
			fmt.Sprintf("The aci_epg_useg_ad_group_attribute data source with id '%s' has not been found", cachedId),
		)
		return
	}
	...
	tflog.Debug(ctx, fmt.Sprintf("End read of datasource aci_epg_useg_ad_group_attribute with id '%s'", data.Id.ValueString()))
}
