...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"aci_action_rule_profile_additional_communities": resourceAciRtctrlSetAddComm(),
		},
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"aci_action_rule_profile_additional_communities": dataSourceAciRtctrlSetAddComm(),
		},
