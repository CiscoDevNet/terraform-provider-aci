...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"aci_cloud_template_external_network":          resourceAciCloudTemplateforExternalNetwork(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"aci_cloud_template_external_network":          dataSourceAciCloudTemplateforExternalNetwork(),
