...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"aci_cloud_credentials":                        resourceAciAccessCredentialtomanagethecloudresources(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"aci_cloud_credentials":                        dataSourceAciAccessCredentialtomanagethecloudresources(),
