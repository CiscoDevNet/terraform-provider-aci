...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"aci_cloud_ad":                                 resourceAciActiveDirectory(),
			"aci_cloud_creddentials":                       resourceAciAccessCredentialtomanagethecloudresources(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"aci_cloud_ad":                                 dataSourceAciActiveDirectory(),
			"aci_cloud_creddentials":                       dataSourceAciAccessCredentialtomanagethecloudresources(),
