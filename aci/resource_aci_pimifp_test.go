...
func TestAccAciInterfaceProfile_Basic(t *testing.T) {
	...
	pim_if_p_name := acctest.RandString(5)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckAciInterfaceProfileConfig_basic(fv_tenant_name, l3ext_out_name, l3ext_lnode_p_name, l3ext_lif_p_name, pim_if_p_name),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAciInterfaceProfileExists("aci_interface_profile.foo_interface_profile", &interface_profile),
					testAccCheckAciInterfaceProfileAttributes(fv_tenant_name, l3ext_out_name, l3ext_lnode_p_name, l3ext_lif_p_name, pim_if_p_name, description, &interface_profile),
				),
			},
		},
	})
...
func testAccCheckAciInterfaceProfileConfig_basic(fv_tenant_name, l3ext_out_name, l3ext_lnode_p_name, l3ext_lif_p_name, pim_if_p_name string) string {
	return fmt.Sprintf(`
	...
	`, fv_tenant_name, l3ext_out_name, l3ext_lnode_p_name, l3ext_lif_p_name, pim_if_p_name)
}
...
func testAccCheckAciInterfaceProfileAttributes(fv_tenant_name, l3ext_out_name, l3ext_lnode_p_name, l3ext_lif_p_name, pim_if_p_name, description string, interface_profile *models.InterfaceProfile) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		if pim_if_p_name != GetMOName(interface_profile.DistinguishedName) {
			return fmt.Errorf("Bad pimif_p %s", GetMOName(interface_profile.DistinguishedName))
		}
