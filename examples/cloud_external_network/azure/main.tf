...
resource "aci_cloud_external_network" "external_network_azure" {
...
resource "aci_cloud_external_network_vpn_network" "vpn_network" {
  aci_cloud_external_network_dn = aci_cloud_external_network.external_network_azure.id
...
data "aci_cloud_external_network" "external_network_example" {
  name = aci_cloud_external_network.external_network_azure.name
}
