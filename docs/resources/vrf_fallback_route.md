...
All examples for the VRF Fallback Route resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_vrf_fallback_route) folder.
