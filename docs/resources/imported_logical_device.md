...
All examples for the Imported Logical Device resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_imported_logical_device) folder.
