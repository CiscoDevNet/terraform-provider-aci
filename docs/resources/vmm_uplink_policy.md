...
All examples for the VMM Uplink Policy resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_vmm_uplink_policy) folder.
