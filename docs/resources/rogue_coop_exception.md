...
All examples for the Rogue Coop Exception resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_rogue_coop_exception) folder.
