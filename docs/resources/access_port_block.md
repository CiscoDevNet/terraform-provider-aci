...
All examples for the Access Port Block resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_access_port_block) folder.
