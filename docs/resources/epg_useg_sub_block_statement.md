...
All examples for the EPG uSeg Sub Block Statement resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_epg_useg_sub_block_statement) folder.
