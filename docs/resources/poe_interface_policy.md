...
* `maximum_power` (max) - (string) The maximum power in milliwatts that is allowed for the PoE Interface Policy object.
  - Default: `"30000"`
  - Valid Values:
    * `"15400"`, `"30000"`, `"4000"`, `"45000"`, `"60000"`, `"7000"`.
    * Or a value in the range of `4000` to `60000`.
