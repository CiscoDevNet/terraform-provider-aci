...
All examples for the Relation To Provided Contract resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/master/examples/resources/aci_relation_to_provided_contract) folder.
...
```
terraform import aci_relation_to_provided_contract.example_application_epg ... add all relevant DNs ...
```
