...
sidebar_current: "docs-aci-resource-aci_relation_to_provided_contract"
description: |-
...
The configuration snippet below creates a Relation To Provided Contract with only required attributes.
...
```
The configuration snippet below shows all possible attributes of the Relation To Provided Contract.
...
All examples for the Relation To Provided Contract resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_relation_to_provided_contract) folder.
