...
All examples for the EPG uSeg DNS Attribute resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_epg_useg_dns_attribute) folder.
