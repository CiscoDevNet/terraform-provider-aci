...
All examples for the Access Port Selector resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_access_port_selector) folder.
