...
All examples for the CoPP Interface Protocol Policy resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_copp_interface_protocol_policy) folder.
