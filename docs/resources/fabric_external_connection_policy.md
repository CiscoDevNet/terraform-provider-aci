...
All examples for the Fabric External Connection Policy resource can be found in the [examples](https://github.com/CiscoDevNet/terraform-provider-aci/tree/main/examples/resources/aci_fabric_external_connection_policy) folder.
