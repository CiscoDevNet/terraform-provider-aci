...
The configuration snippet below shows an example for Relation To Imported Contract with only required attributes. This snippet retrieves a list of all Relation To Imported Contract objects.
