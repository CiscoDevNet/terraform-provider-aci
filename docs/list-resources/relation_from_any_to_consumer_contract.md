...
The configuration snippet below shows an example for Relation From Any To Consumer Contract with only required attributes. This snippet retrieves a list of all Relation From Any To Consumer Contract objects.
