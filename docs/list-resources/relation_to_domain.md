...
The configuration snippet below shows an example for Relation To Domain with only required attributes. This snippet retrieves a list of all Relation To Domain objects.
