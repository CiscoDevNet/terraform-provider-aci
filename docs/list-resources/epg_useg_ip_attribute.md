...
The configuration snippet below shows an example for EPG uSeg IP Attribute with only required attributes. This snippet retrieves a list of all EPG uSeg IP Attribute objects.
