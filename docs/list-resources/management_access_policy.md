...
The configuration snippet below shows an example for Management Access Policy with only required attributes. This snippet retrieves a list of all Management Access Policy objects.
