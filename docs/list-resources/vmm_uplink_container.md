...
The configuration snippet below shows an example for VMM Uplink Container with only required attributes. This snippet retrieves a list of all VMM Uplink Container objects.
