...
The configuration snippet below shows an example for EPG uSeg DNS Attribute with only required attributes. This snippet retrieves a list of all EPG uSeg DNS Attribute objects.
