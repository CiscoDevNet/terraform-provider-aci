...
The configuration snippet below shows an example for NetFlow Exporter Policy with only required attributes. This snippet retrieves a list of all NetFlow Exporter Policy objects.
