...
The configuration snippet below shows an example for L3Out Provider Label with only required attributes. This snippet retrieves a list of all L3Out Provider Label objects.
